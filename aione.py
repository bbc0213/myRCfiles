...
def process_management():
    ...
    if os.path.exists('./JSONWRONG'):
        TraceId = 'wrongjson'
        f = zipfile.ZipFile('./exec/' + TraceId + '/' + TraceId + '.zip','w')
            
        f.write(os.path.join('./wrongjson.vml'))

        f.close

        with open('./exec/' + TraceId + '/' + TraceId + '.zip','rb') as f:
            file_base64 = f.read()
        ...
        if(receiveNO == '00000000'):
            ...
            f = zipfile.ZipFile('./exec/' + vmlTraceId + '/' +  vmlTraceId + '.zip','w')
            ...
            with open('./exec/' + vmlTraceId + '/' +  vmlTraceId + '.zip','rb') as f:
                file_base64 = f.read()           
                base64_data = base64.b64encode(file_base64)

        else:

            f = zipfile.ZipFile('./exec/' + TraceId + '/' +  TraceId + '.zip','w',zipfile.ZIP_DEFLATED) 
